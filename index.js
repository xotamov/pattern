...
function REJEX(regex, patern) {
    if (regex.test(field.value)) {
        patern.parentElement.classList.remove('error')
        patern.parentElement.classList.add('not error')
    } else {
        patern.parentElement.classList.remove('not error')
        patern.parentElement.classList.add('error')
    }
}
